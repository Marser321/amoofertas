...
- `/ofertas`: landing principal con Comunidad Mandy Academy y Evaluación personalizada.
- `/evaluacion`: funnel VSL dedicado a la evaluación de $100. Se distribuye mediante campañas y no se enlaza desde la landing principal.
- `/gracias?offer=comunidad`: próximos pasos de la membresía.
- `/gracias?offer=evaluacion`: agenda posterior a la evaluación.
...
- Comunidad: `/gracias?offer=comunidad`
- Evaluación: `/gracias?offer=evaluacion`
